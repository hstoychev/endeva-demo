  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="https://i.imgur.com/8mED3ym.jpg" style="width:100%" alt="Avatar">
          <div class="w3-display-bottomleft w3-container w3-text-black">
            <h2>Hristo Stoychev</h2>
          </div>
        </div>
        <div class="w3-container">
          ...
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:90%">75%</div>
          </div>
          <p>Infrastructure</p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
          ...
          <p>BigData/DataScience/MachineLearning</p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
          ...
          <div class="w3-light-grey w3-round-xlarge">
            <div class="w3-round-xlarge w3-teal" style="height:24px;width:850%"></div>
          </div>
          <p>French</p>
          <div class="w3-light-grey w3-round-xlarge">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Microsoft: Implementing Microsoft Azure Infrastructure Solutions </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Forever</h6>
          <p>Azure Resource Manager Infrastructure certifications.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>AWS Certified Solutions Architect — Associate</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Forever</h6>
          <p>AWS Infrastructure certification.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Several others certificates for Microsoft technologies (virtualizations, server 2012 and etc) and Data Science and Machine Learning</b></h5>
...
<footer class="w3-container w3-teal w3-center w3-margin-top">
  ...
  <i class="https://twitter.com/StoychevHristo"></i>
  <i class="https://www.linkedin.com/in/hristo-stoychev-%E2%98%81-0682524a/"></i>
  <p>Powered by Icaka.</p>
</footer>
